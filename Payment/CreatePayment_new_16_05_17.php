    ...
    <div id='wrap'>
            ...
            <div class="panel panel-sky">
                ...
                <div class="panel-body" align="right">
                    <div class="panel-body collapse in">
                        <form  id="payment_gw" name="payment_gw" method="POST" action="<?php echo $paymentGateWayPostAPITest; ?>">
                            <input type="hidden" name="store_id" id="store_id" value="<?php echo PAYMENT_GATEWAY_STORE_ID_TEST; ?>" />
        ...
        <script type="text/javascript">
            ...
            function calculate(identity) {
                ...
                var smsPrice = 0;
                if (IsSubscribed == <?php echo IsSubscribedOn; ?> && numberOfSMS <= <?php echo PACKAGE_TYPE_ID_SUBSCRIBER_NUMBER_OF_SMS; ?>) {
                    if (identity == 1) {
                        $("#NumberOfSMS").val(<?php echo PACKAGE_TYPE_ID_SUBSCRIBER_NUMBER_OF_SMS; ?>);
                    } else if (identity == 3) {
                        $("#NumberOfSMS").val(<?php echo PACKAGE_TYPE_ID_SUBSCRIBER_NUMBER_OF_SMS; ?>);
                        numberOfSMS = $("#NumberOfSMS").val();
                        alert("For Subscriber  the Minimum Purchase Quantity is 3500 SMS.");
                    }
                ...
                } else if (selectedPackage == <?php echo PACKAGE_TYPE_ID_NON_MASKING; ?> && numberOfSMS <= 1000) {
                ...
                } else if (selectedPackage == <?php echo PACKAGE_TYPE_ID_NON_MASKING; ?> && numberOfSMS >= 5000) {
