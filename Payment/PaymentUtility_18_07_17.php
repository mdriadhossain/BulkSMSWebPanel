...
if (isset($_POST)) {
    ...
    echo $insertMaskingDetailquery = "INSERT INTO MaskingDetail (UserName, MaskingID,RequestingIP,MaskingForGP,MaskingForRO,MaskingForBL,MaskingForAT,MaskingForTT,MaskingForCC) VALUES ('$UserName', '$UserName', '$RequestingIP','$GPMaskingIsActive','$ROMaskingIsActive','$BLMaskingIsActive','$ATMaskingIsActive','$TTMaskingIsActive','$CCMaskingIsActive')";
