...
//                            $transation_info->MobileNo = $userInfo['MobileNo'];
                            ...
                            $insertquery = "INSERT INTO OnlinePaymentHistory (UserName,Amount,TransactionId,Status,Response,DataEntryDate,HashValStatus) VALUES "
                            . "('$transation_info->UserName','$transation_info->Amount','$transation_info->TransactionId','$transation_info->Status','$transation_info->Response','$transation_info->DataEntryDate','$transation_info->HashValStatus')";
...
//Payment validation check
                            ...
                            if ($code == 200 && !( curl_errno($handle))) {
                                ...
                                echo "<br>Please check your mail for confirmation! Thank You!!!.</br>";
                            } else {
    ...
    <script type="text/javascript">
        $(function () {
            ...
            if (typeof transactionId !== 'undefined' && transactionId != "") {
                ...
                TansactionDataArray.gatewayName = $.session.get('gatewayName');
                TansactionDataArray.proceAmount = $.session.get('proceAmount');
                TansactionDataArray.MobileNo = $.session.get('MobileNo');
                $.ajax({
                    type: 'POST',
                    url: url,
                    ...
                    success: function (data) {
                        ...
                        $.session.remove('gatewayName');
                        $.session.remove('proceAmount');
