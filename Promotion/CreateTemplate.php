...
//                                        }
                    ...
                    if ($_REQUEST['Save'] == 'Save') {
                        ...
                        // if ($ckMaskingID == 0) {
                        $insertMaskingDetailquery = "INSERT INTO TemplateText (UserName, TemplateSMS,UploadedBy,UploadedDate) VALUES ('$UserName', N'$SMSText', '$UploadedBy',getdate())";
                        // exit;
                        $stmtInsert = $conn->query($insertMaskingDetailquery);
