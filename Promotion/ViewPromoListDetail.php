                    ...
                    <div class="container">
                        <div class="panel panel-sky">
                            ...
                            <div class="panel-heading">
                                <h4>View Scheduled List Detail </h4>
                            </div>
                            <div class="panel-body">
                                <?php
                                $OutboxQuery = "select [MSISDN],[UserName],[PromoListName],[UpdateDate],[UpdateBy] from [BULKSMSPanel].[dbo].[PromoList] where PromoListName='$PromoListName' and UserName='$UserName2'";
$_SESSION['xls_query'] = $OutboxQuery;
                                //echo $OutboxQuery."<br/>";
                                ?>
                                <table  class="table table-bordered table-condensed">
                                    <tr class="TableTopHeader"><td colspan="4">Schedule List Detail</td>
                                        <td><a href="../Lib/ExportToExcel.php"/><button type="button" class="btn btn-primary btn-block">Export To Excel</button></a></td>
                                    </tr>
                                    <tr>
                                        <td>Promotional List Name</td>
                                        <td>User Name</td>
                                        <td>Number of MSISDN</td>
                                        <td>Updated Date</td>
                                        <td>Updated By</td>
                                    </tr>
                                    <?php
     ...
     <div class="container">
            ...
            <p align="right">solvers &copy; 2014</p>
