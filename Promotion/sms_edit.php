...
$id = $_GET['id'];
$ViewTemplateQuery = "SELECT  TemplateSMS  FROM TemplateText where id='$id'";
//$sth = $conn->query($EditSql);
                    ...
                    <div class="panel-body collapse in">
                        ...
                        <script language="JavaScript" type="text/javascript">
                            ...
                            if ($_REQUEST['Submit'] == 'Update') {
                                ...
                                $UpdateSMSTextquery = "UPDATE TemplateText SET TemplateSMS = N'$TemplateSMS' where id='$id'";
                                $stmtInsert = $conn->query($UpdateSMSTextquery);
                                //exit;
