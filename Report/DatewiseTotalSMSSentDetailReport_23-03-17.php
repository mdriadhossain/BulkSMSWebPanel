UserName<style> div.ViewPanel{width:100%;height:600px;overflow:scroll;}</style>
<div class="ViewPanel">
    <?php
                    ...
                    <div class="container">
                        <div class="panel panel-sky">
                            ...
                            <div class="panel-heading">
                                <h4>Datawise Total SMS Log Detail </h4>
                            </div>
                            <div class="panel-body">
                                <?php
                               
                                $OutboxQuery = "select [srcMN],[dstMN],[msg],[writeTime],[msgStatus],[retrycount],[Schedule],[srcAccount] from $db where srcAccount='$UserNameID' and writeTime between '$stTime' and '$etTime' ";
                               
                                $_SESSION['xls_query'] = $OutboxQuery;
                                ?>
                                <table  class="table table-bordered table-condensed">
                                    <tr class="TableTopHeader"><td colspan="7">SMS QUE Detail</td>
