...
<div class="ViewPanel">
    ...
    <head>
        ...
        <script type="text/javascript" src="../assets/table-to-excel/dist/tableToExcel.js"></script>
    ...
    <body class="">
                ...
                <div class="container">
                    <div class="panel panel-sky">
                        ...
                        <div class="panel-heading">
                            <h4>Real Time Log Detail </h4>
                        </div>
                        <div class="panel-body">
                            <?php

                            if ($Param == 'QUE') {
                                $OutboxQuery = "select [srcMN],[dstMN],[msg],[writeTime],[msgStatus],[retrycount],[Schedule],[srcAccount] from BULKSMSGateway_1_0.[dbo].[SMSOutbox] where msgStatus='QUE'  and srcAccount='$UserNameID'";
                            } else if ($Param == 'POSTED') {
                                $OutboxQuery = "select [srcMN],[dstMN],[msg],[writeTime],[msgStatus],[retrycount],[Schedule],[srcAccount] from BULKSMSGateway_1_0.[dbo].[SMSOutbox_Back] where srcAccount='$UserNameID'";
                            }
                            ...
                            <table class="table table-bordered table-condensed" id="example">
                                <tr class="TableTopHeader">
                                    <td colspan="7">SMS Detail</td>
                                    <td><button type="submit" id="downloadExcel" class="btn btn-primary btn-block">Export To Excel</button></td>
                                ...
                                <?php
                                $conn = PDOConnectDB();
                                foreach ($conn->query($OutboxQuery) as $row) {
        ...
        <script type="text/javascript">
            $(function() {
                ...
                // $('#example').find("tr td:nth-child(5)").each(function(){$(this).remove()});
                // $('table tr').find('td:eq(7),th:eq(8)').remove();
                // break;
                today = mm + '-' + dd + '-' + yyyy + ' ' + HH + " : " + MI + " : " + S;
                $('#downloadExcel').click(function() {
                    // $('#example').find("tr th:nth-child(9)").each(function() {
                    //     $(this).remove()
                    // });
                    // $('#example').find("tr td:nth-child(9)").each(function() {
                    //     $(this).remove()
                    // });
                    // alert("ok");
                    ...
                    //  location.href = url;
                    //  location.download = "my-custom-filename.xls";
                    //  return false
                    TableToExcel.convert(document.getElementById("example"), {
                        name: "RealTimeLogDetailReport-" + today + ".xlsx",
                        sheet: {
                            name: "Sheet 1"
                        }
                    });
