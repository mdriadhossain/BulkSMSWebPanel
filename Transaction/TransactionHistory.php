...
<!--                                   <input class="form-control" name="PerSMSRate" type="text" id="PerSMSRate" oninput="calculate()" >                                    -->
                    ...
                    if ($_REQUEST['Save'] == 'Save') {
                        ...
                        $insertquery = "INSERT INTO TransactionHistory (UserName, NumberOfSMS,TransactionType, PerSMSRate, Amount,FromMainAccount, LastMainBalance) VALUES ('$UserName', '$NumberOfSMS', '$TransactionType', '$PerSMSRate','$Amount','$PurchaseFromAccount', '$TotalNumberOfSmsVal')";

                        $rs = odbc_exec($cn, $insertquery);

                        $insertqueryadmin = "INSERT INTO TransactionHistory (UserName, NumberOfSMS,TransactionType, PerSMSRate, Amount,FromMainAccount,LastMainBalance) VALUES ('admin', '$NumberOfSMS', 'Debit', 'NULL','NULL','$PurchaseFromAccount', '$UserCurrentSmsVal')";
                        ...
                        if ($r > 0) {
                            ...
                            $MailURL = get_mail_server_url() . "test_smtp_basic_th.php?sub=transaction history&email=$UserEmail&NumberOfSMS=$NumberOfSMS";
