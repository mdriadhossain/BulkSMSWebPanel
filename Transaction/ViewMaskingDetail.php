                        ...
                        if ($_REQUEST['Search'] == 'GETReport') {
                           ...
                           // echo "UserName=".$UserName."|User=". $User;
                            ...
                            if (($User == 'ADMIN') and $UserName != null) {
                                $ViewMaskingDetailQuery = "SELECT  ID,UserName,MaskingID,RequestingIP,[MaskingForGP],[MaskingForRO],[MaskingForBL],[MaskingForAT],[MaskingForTT]  FROM MaskingDetail WHERE  UserName='$UserName'";
                            } elseif (($User == 'ADMIN')and $UserName == null) {
                                $ViewMaskingDetailQuery = "SELECT  ID,UserName,MaskingID,RequestingIP,[MaskingForGP],[MaskingForRO],[MaskingForBL],[MaskingForAT],[MaskingForTT]  FROM MaskingDetail ";
                            } else {
                                $ViewMaskingDetailQuery = "SELECT  ID,UserName,MaskingID,RequestingIP,[MaskingForGP],[MaskingForRO],[MaskingForBL],[MaskingForAT],[MaskingForTT]  FROM MaskingDetail WHERE  UserName='$User'";
                            }
