                    ...
                    <?php
                        if ($_REQUEST['Search'] == 'GETReport') {
                            ...
                            if (($User == 'Admin') and $UserName != null) {
                                $ViewMaskingDetailQuery = "SELECT  ID,UserName,MaskingID,RequestingIP  FROM MaskingDetail WHERE  UserName='$UserName'";
                            } elseif (($User == 'Admin')) {
                                $ViewMaskingDetailQuery = "SELECT  ID,UserName,MaskingID,RequestingIP  FROM MaskingDetail ";
                            } else {
                                $ViewMaskingDetailQuery = "SELECT  ID,UserName,MaskingID,RequestingIP  FROM MaskingDetail WHERE  UserName='$User'";
                            }
