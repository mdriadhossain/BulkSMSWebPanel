                ...
                <div class="panel-body">
                    ...
                    <div class="panel-body collapse in">
                        ...
                        if ($_REQUEST['Save'] == 'Show') {
                            ...
                            if ($check == "chk") {
                                $showUser = "select UserID,UserName,Password,MobileNo,CompanyName,CreateDate,HeaderText,Email from UserInfo where UserName<>'admin'";

                                //$showUser1 = "select MaskingID from MaskingDetail where UserName<>'admin'";
                            } else {
                                $showUser = "select UserID,UserName,Password,MobileNo,CompanyName,CreateDate,HeaderText,Email from UserInfo where UserID='$UserId'";
