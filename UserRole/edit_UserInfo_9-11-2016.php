    ...
    <body class="">
                                ...
                                <table  class="table table-bordered table-condensed">
                                    ...
                                    <form id="role" name="role" method="post" action="<?php echo $PHP_SELF; ?>" enctype="multipart/form-data">
                                        ...
                                        <tr>
                                            <td >UserID: </td>
                                            <td>
                                                <input name="UserID" type="text" id="UserID" readonly="readonly"  value="<?PHP echo $UserId; ?>">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td >User Name: </td>
                                            <td>
                                                <input name="UserName" type="text" id="UserName"  value="<?PHP echo $UName; ?>">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td >Password: </td>
                                        ...
                                        <tr>
                                            <td >Create Date: </td>
                                            <td>
                                                <input name="CreateDate" type="text" id="CreateDate" readonly="readonly"  value="<?PHP echo $createDate; ?>" >
                                            </td>
                                        </tr>
        ...
        if ($_REQUEST['Save'] == 'Update') {
            ...
            if ((empty($UserName)) || (empty($Password))) {
                ...
                $update = "update UserInfo set UserName='$UserName', Password = '$Password', MobileNo = '$MobileNo', CompanyName = '$CompanyName', CreateDate=getdate(),HeaderText = '$HeaderText' where UserID='$UserID'";
