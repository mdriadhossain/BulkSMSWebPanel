...
?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
									...
									<b>Please do not upload any Bangla sms using CSV option.<b/> <br/>
...
//$p= base_url()."CSV/".$header;		//server	
  ...
  $Usernumbertable = $UserName . 'number';
   ...
   $sql_createusertable = "CREATE TABLE #$Userinfotable(
     ...
     echo $sql_insertdata = "Insert into [BULKSMSPanel].[dbo].[#$Userinfotable] 
...
VALUES('$SendFrom',N'.$Msg', getdate(),'', 'QUE', '3', '1','1', 'TEXT', '64', '1', '1', '1', '','$ScheduleTime','$UserName', '$UserName', '','','' )";
         ...
         $stmt = $conn->query($sql_insertdata);  
