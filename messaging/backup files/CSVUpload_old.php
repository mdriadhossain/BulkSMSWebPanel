...
if ($_REQUEST['submit'] == "send") {
    ...
    $filelink = "./CSV/" . $header;
    $p = "D:/wwwroot/bulksmswebpanel/CSV/" . $header;
    //echo $q= base_url()."CSV/".$header;					                        
...
(srcMN, msg, writeTime, sentTime, msgStatus, retrycount, srcTON, srcNPI, msgType, esm_Class, Data_Coding, smsPart, totalPart, refID,srcAccount, destAccount, Remarks,ContentSubCategoryID,ServiceID)
VALUES('$SendFrom','$Msg', getdate(),'', 'QUE', '3', '1','1', 'TEXT', '64', '1', '1', '1', '','$UserName', '$UserName', '','','' )";
        ...
        $sql_insertoutbox = "INSERT [BULKSMSGateway_1_0].[dbo].[SMSOutbox]  (srcMN,dstMN, msg, writeTime, sentTime, msgStatus, retrycount, srcTON, srcNPI, msgType, esm_Class, Data_Coding, smsPart, totalPart, refID,srcAccount, destAccount, Remarks,ContentSubCategoryID,ServiceID,IN_MSG_ID)
Select srcMN,MSISDN, msg, writeTime, sentTime, msgStatus, retrycount, srcTON, srcNPI, msgType, esm_Class, Data_Coding, smsPart, totalPart, refID,srcAccount, destAccount, Remarks,ContentSubCategoryID,ServiceID,IN_MSG_ID
