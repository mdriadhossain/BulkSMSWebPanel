                ...
                <div class="panel-body">
                    <div class="panel-body collapse in">
                        <form onSubmit="return validationCheck()" class="form-horizontal" action="" method="post" enctype="multipart/form-data" name="SchedulePromotionID" id="user" >
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input onClick="return confirm('Do you want to send this SMS?')" class="btn btn-primary" name="submit" type="submit" value="send">
                    ...
                    if ($_REQUEST['submit'] == "send") {
                        ...
                        $Msg = $_REQUEST['SMSText'];
                         ...
                         if(strlen($Msg)>160){                             
                             $TotalCharLen= strlen($Msg);
                             $CuttedString = substr($Msg,0,160);                             
                             $Notification="Your unicode SMS is more than 160 character. Total length of the SMS is: $TotalCharLen character.  Please use up to ".$CuttedString;                             
                             MsgBox($Notification);
                             exit;                                                        
                           }
